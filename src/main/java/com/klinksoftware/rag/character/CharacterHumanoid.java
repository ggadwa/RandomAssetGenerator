...
@CharacterInterface
public class CharacterHumanoid extends CharacterBase {
    ...
    public void buildMeshes() {
        ...
        // build the skeleton
        skeletonBuilder = new SkeletonBuilder(scene, SkeletonBuilder.MODEL_TYPE_HUMANOID, (AppWindow.random.nextFloat() > 0.2f), true);
        ...
        if (AppWindow.random.nextBoolean()) {
            scene.randomizeVertexes((0.2f + AppWindow.random.nextFloat(0.3f)), (0.025f + AppWindow.random.nextFloat(0.05f)));
        }
