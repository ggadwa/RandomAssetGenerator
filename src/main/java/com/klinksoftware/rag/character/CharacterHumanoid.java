...
public class CharacterHumanoid extends CharacterBase {
    ...
    public void buildMeshes() {
        ...
        if (organic) {
            ...
            scene.bitmapGroup.add("foot", new String[]{"Fur", "Organic", "Scale"});
        ...
        // build the skeleton
        skeletonBuilder = new SkeletonBuilder(scene, SkeletonBuilder.MODEL_TYPE_HUMANOID, bilateral, organic);
